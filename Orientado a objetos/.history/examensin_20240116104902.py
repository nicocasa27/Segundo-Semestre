...
variable = {
    "Casa_Velaryon": Casa_Velaryon,
    "Casa_Stark": Casa_Stark,
    "Casa_Hightower": Casa_Hightower,
    "Casa_Lannister": Casa_Lannister,
    "Casa_Martell": Casa_Martell,
    "Casa_Tyrell": Casa_Tyrell,
    "Casa_Baratheon": Casa_Baratheon
}

variable_minima = min(variable, key=variable.get)
print("La casa que menos aporto es:", variable_minima)

time.sleep(2)

print("El lord esta Evaluando si lo dejara vivir o no...")
time.sleep(1)
print(".")
time.sleep(1)
print("..")
...
print("Lord, desea matalo? Y/N")

# if input = Y = "Tiene una oportunidad de vivir"
# if not "El lord de la casa ", {variable_minima} " ha muerto"

# Solicitar entrada al usuario
if input("Ingrese 'Y' para tener una oportunidad de vivir: ") == "Y":
    print("Tiene una oportunidad de vivir")

# Verificar si el lord de la casa ha muerto
if not f"El lord de la casa {variable_minima} ha muerto":
    print("El lord de la casa ha muerto")
